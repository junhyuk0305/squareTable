...
async function main() {
  ...
  { const { error } = await j.from('playbook_entries').insert({ id: `pb_csj_${s}`, unit_id: UNIT, creator_id: jId, creator_name: 'QA직원', category: 'Routine', subcategory: '음료 제조', title: '직원 노하우', tags: [], search_keywords: ['직원'], square: { situation: '테스트', action: { steps: ['한다'] }, extract: { do: '', dont: '', template: '' }, result: { before: '', after: '', metric: '' }, uncover: '', quagmire: '' }, execution: { tone: '', timing: '', channel: '', stakeholders: [] }, stats: { thumbs_up: 0, thumbs_down: 0, last_used_at: null, query_hits_30d: 5, resolution_rate: 0 }, photos: [], version: 1, status: 'published', quality_score: 0.7, created_at: now, updated_at: now, is_template: false, pack_id: null, needs_review: false, correction_points: [], section: null, order_index: 0 });
