...
export default function AccountEdit() {
  ...
  const { userName, email } = useSessionStore();
    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <Pressable disabled={busy} onPress={saveProfile} style={({ pressed }) => [styles.primary, pressed && { opacity: 0.88 }, busy && { opacity: 0.6 }]}>
        ...
        <View style={styles.card}>
          ...
          <Pressable disabled={busy} onPress={savePw} style={({ pressed }) => [styles.secondary, pressed && { opacity: 0.88 }, busy && { opacity: 0.6 }]}>
