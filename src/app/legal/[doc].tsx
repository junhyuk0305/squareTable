...
const DOCS: Record<string, Doc> = {
  collect: {
    ...
    sections: [
      ...
      { h: '처리 위탁 및 국외 이전', b: '데이터 보관은 Supabase(싱가포르), 노하우 구조화·검색·답변 생성은 AI 처리 수탁사 Google(Gemini API, 미국), 앱 푸시 알림 전달은 Expo·Google·Apple(미국), 앱에서 구독을 구매한 경우 결제 영수증 검증·구독 상태 관리는 RevenueCat(미국)이 처리합니다. 입력하신 내용은 AI 모델 학습에 사용되지 않으며, 휴대전화번호·근로정보는 AI로 보내지 않습니다.' },
