    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.confirmHead}>
          <Text style={styles.h2}>교대 컨펌</Text>
          {pending.length > 0 && (
        ...
        {/* ③ 직원 근무표 편집 */}
        <Text style={styles.h2}>직원 근무표</Text>
        {staff.length === 0 ? (
          <View style={styles.emptyBox}>
        ...
        {/* ④ 주간 전체 근무표 */}
        <Text style={styles.h2}>전체 근무표</Text>
        <ScheduleWeek
          monday={monday}
          setMonday={setMonday}
          templates={templates}
...
const styles = StyleSheet.create({
  ...
  h2: { fontSize: 16, fontWeight: '900', color: InkColors.ink, marginTop: 6 },
  confirmHead: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  ...
  actBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingVertical: 12, borderRadius: 12 },
  ...
  avatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: InkColors.bgSoft, borderWidth: 1, borderColor: InkColors.line, alignItems: 'center', justifyContent: 'center' },
  ...
  editText: { fontSize: 13, fontWeight: '800', color: '#fff' },
});
