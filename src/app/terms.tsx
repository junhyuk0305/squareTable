    ...
    <SafeAreaView style={styles.safe} edges={[]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Section title="제3조 (유료 서비스 및 결제)">
          일부 기능은 매장 단위 월 선불 이용권으로 제공됩니다. 결제는 웹(dochackchack.com)에서 계좌이체로만 하며, 앱 안에서는 결제하지 않습니다. 회사는 결제수단을 저장하지 않고 자동결제·자동청구를 하지 않습니다.
        </Section>
        <Section title="제4조 (무상 이용기간·이용권 종료·환불)">
          신규 매장에는 일정 기간(예: 14일) 유료 기능을 무상 제공할 수 있으며, 기간이 끝나도 자동으로 요금이 청구되지 않습니다. 이용권이 끝나면 무료 요금제로 전환되고 매장 데이터는 삭제되지 않습니다. 환불은 전자상거래법 및 약관 전문 제13조(개시 전 전액, 미사용 7일 이내 전액, 이용 중 해지 시 일할 정산)에 따릅니다.
        </Section>
