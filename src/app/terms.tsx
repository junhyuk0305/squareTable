    ...
    <SafeAreaView style={styles.safe} edges={[]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Section title="제3조 (유료 서비스 및 결제)">
          일부 기능은 매장 단위 월 선불 이용권으로 제공됩니다. 앱에서 구매하신 이용권은 앱 마켓을 통한 월 단위 자동 갱신 구독이며, 해지하시기 전까지 갱신일마다 자동으로 결제됩니다. 해지는 기기 설정의 구독 목록에서 언제든지 하실 수 있습니다. 회사는 카드번호·계좌번호 등 결제수단 정보를 수집하거나 보관하지 않습니다.
        </Section>
