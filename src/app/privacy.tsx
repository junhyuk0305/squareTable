    ...
    <SafeAreaView style={styles.safe} edges={[]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Section title="4. 처리 위탁·국외 이전">
          인증 문자 발송은 솔라피(국내)에 위탁합니다. 데이터 보관(Supabase, 싱가포르), AI 처리(Google, 미국), 푸시 알림 전달(Expo·Google·Apple, 미국), 웹 이용 분석(PostHog, 미국), 웹 호스팅(Vercel, 미국), 앱에서 구독을 구매한 경우 결제 영수증 검증·구독 상태 관리(RevenueCat, 미국)는 국외 사업자가 처리합니다. 휴대전화번호·시급·출퇴근 등 개인 식별·근로 정보는 AI로 보내지 않습니다. 항목·보유기간·거부 방법은 전문 제5조·제6조에 있습니다.
        </Section>
