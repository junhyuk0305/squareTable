...
Deno.serve(async (req) => {
  ...
  const HANDLED = ['INITIAL_PURCHASE', 'RENEWAL', 'PRODUCT_CHANGE', 'UNCANCELLATION', 'CANCELLATION', 'EXPIRATION'];
  ...
  // CANCELLATION = "다음 달에 안 낸다"는 예고일 뿐이다. 기간 끝까지는 그대로 쓴다 → 슬롯을 건드리지 않는다.
